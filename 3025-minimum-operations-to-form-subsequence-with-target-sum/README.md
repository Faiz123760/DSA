...
# [Minimum Operations to Form Subsequence With Target Sum](https://leetcode.com/problems/minimum-operations-to-form-subsequence-with-target-sum) ![](https://img.shields.io/badge/Hard-red)
